...
<body>
    <div class="container">
        <br>
        <center>
            <H1>Listado de servicios y fotografias</H1>
        </center>
        <br>
        <div class="container">
            ...
            <br>
            <br>
            <a href="Nuevo.php" class="btn btn-dark">Agregar Servicio/fotografia</a>
            <hr>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    while ($Fila = $resultado->fetch_assoc()) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="Vista.php?Id=<?php echo $Fila["Id"]?>" class="btn btn-warning">Editar</a>
